...
class LogAktivitasPolicy
{
    ...
    {
        return $user->can('view_any_log::aktivitas');
    }
    ...
    {
        return $user->can('view_log::aktivitas');
    }
    ...
    {
        return $user->can('create_log::aktivitas');
    }
    ...
    {
        return $user->can('update_log::aktivitas');
    }
    ...
    {
        return $user->can('delete_log::aktivitas');
    }
    ...
    {
        return $user->can('delete_any_log::aktivitas');
    }
